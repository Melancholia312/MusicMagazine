# Generated by Django 3.2.7 on 2021-10-01 23:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.TextField(blank=True, null=True, verbose_name='Комменатрий к заказу')),
        ...
        migrations.AddField(
            model_name='cart',
            name='products',
            field=models.ManyToManyField(blank=True, null=True, related_name='related_cart', to='musicshop.CartProduct'),
        ),
        migrations.CreateModel(
            name='Artist',
            fields=[
                ...
                ('slug', models.SlugField()),
                ('image', models.ImageField(blank=True, null=True, upload_to=utils.uploading.upload_function)),
                ('genre', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='musicshop.genre', verbose_name='Жанр')),
